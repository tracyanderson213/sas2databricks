...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  [[ -x $_cc_bin ]] || _cc_bin=/home/app/.local/bin/claude
...
export PATH=/app/python/source_code/.venv/bin:/tmp/jq-v1.7.1:/tmp/databricks-cli-v1.15.0:/usr/local/bin:/usr/bin:/bin:.venv/bin:node_modules/.bin
